...
if __name__ == "__main__":
    ...
    #mesh = read_vtp("splines/aneurisk/mallaslinux/0074a.vtp")
    ##el 8, 12 necesita lo del ratio

    #num_file = np.load("splines/aneurisk/trees/0003-original.npy")
    num_file = np.load("splines/aneurisk/corregidas/trees_02/0074a_02.npy")
    ...
    #num_file = np.load("splines/aneurisk/corregidas/trees/099.npy")
    #num_file = np.load("reconstruido.npy")
    all_tck = []
    ...
    visualize_vtk_polydata(centerline, splines_2, "Splines Visualization")